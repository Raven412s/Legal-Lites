...
const Sidebar: React.FC<SidebarProps> = ({ isMinimized, onToggle }) => {
  ...
  return (
    <div
      className={`bg-primary dark:bg-zinc-900 text-secondary dark:text-primary sticky top-0 h-screen transition-all duration-300 flex flex-col justify-between ${
    ...
    >
      ...
      <div className={`p-4  flex  gap-8 items-center ${isMinimized ? 'justify-center flex-col' : 'justify-end  flex-row'}`}>
        <ModeToggle />
