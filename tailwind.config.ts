...
const config: Config = {
  ...
  theme: {
  	extend: {
        backgroundImage: {
            'loon-crest': 'linear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at top center, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.40) 120%) #989898',
